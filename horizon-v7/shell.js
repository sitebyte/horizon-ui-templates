...
function buildHeader(pageTitle) {
  ...
  html += '  <button class="hz-header-toggle" onclick="toggleSidebar()" title="Toggle sidebar (Cmd+B)">' + svg('menu', 16) + '</button>';
...
function buildStatusBar() {
  ...
  html += '<span style="margin-left:auto;">Horizon ETRM v7.0</span>';
  html += '</div>';
  return html;
}
