/* ============================================================
   HORIZON ETRM v14.0 — AI-Aware Shared Shell Builder
...
/* ========== FULL ETRM MENU (v14 — AI-aware, EOS-complete) ========== */
var MENU = [
  {
    group: 'TRADING', defaultOpen: true, items: [
      ...
      { label: 'Trade Detail', icon: 'git-merge', href: 'lifecycle.html', key: 'lifecycle' },
      { label: 'Trade Capture', icon: 'file-text', href: 'trade-form.html', key: 'trade-form' },
      { label: 'Blotter', icon: 'list', href: 'blotter.html', key: 'blotter', children: [
        { label: 'All Trades', href: 'blotter.html#all', key: 'blotter-all' },
        { label: 'My Trades', href: 'blotter.html#mine', key: 'blotter-mine' },
        { label: 'Pending Approval', href: 'blotter.html#pending', key: 'blotter-pending' },
      ] },
      { label: 'Positions', icon: 'bar-chart-2', href: 'positions.html', key: 'positions', children: [
        { label: 'Position Ladder', href: 'positions.html#ladder', key: 'pos-ladder' },
        { label: 'Exposure Report', href: 'positions.html#exposure', key: 'pos-exposure' },
      ] },
      { label: 'Hedge Book', icon: 'shield', href: 'hedges.html', key: 'hedges' },
      {
        label: 'Valuations', icon: 'trending-up', key: 'valuations', href: 'valuations.html', children: [
          { label: 'Portfolio MTM', href: 'valuations.html#portfolio', key: 'val-portfolio' },
          { label: 'P&L Attribution', href: 'valuations.html#pnl', key: 'val-pnl' },
          { label: 'Exposure', href: 'valuations.html#exposure', key: 'val-exposure' },
        ]
      },
    ]
  },
    ...
    group: 'CONTRACTS', defaultOpen: false, items: [
      { label: 'Master Agreements', icon: 'file-text', href: 'master-agreements.html', key: 'master-agreements' },
      {
        label: 'Contracts', icon: 'clipboard', href: 'contracts.html', key: 'contracts', children: [
          ...
          { label: 'Draft Contracts', href: 'contracts.html#draft', key: 'draft-contracts' },
        ]
      },
      { label: 'Counterparties', icon: 'users', href: 'counterparties.html', key: 'counterparties' },
    ]
  },
  {
    group: 'PHYSICAL', defaultOpen: false, items: [
      { label: 'Cargo Board', icon: 'truck', href: 'cargo-board.html', key: 'cargo-board', children: [
        { label: 'Active Cargoes', href: 'cargo-board.html#active', key: 'cargo-active' },
        { label: 'Cargo Audit', href: 'cargo-board.html#audit', key: 'cargo-audit' },
      ] },
      { label: 'Cargo Matching', icon: 'git-merge', href: 'cargo-matching.html', key: 'cargo-matching', badge: { count: 4, color: 'amber' } },
      {
      ...
      {
        label: 'Vessel Charters', icon: 'anchor', href: 'vessel-charters.html', key: 'vessel-charters', children: [
          { label: 'Active Charters', href: 'vessel-charters.html#active', key: 'active-charters' },
          { label: 'Vessel Usage', href: 'vessel-charters.html#usage', key: 'vessel-usage' },
          { label: 'Bunker Actualisation', href: 'vessel-charters.html#bunkers', key: 'bunkers' },
        ]
      },
      { label: 'Manage Schedule', icon: 'clock', href: 'manage-schedule.html', key: 'manage-schedule' },
      { label: 'Shipments', icon: 'navigation', href: 'cargo-board.html', key: 'shipments' },
    ]
  },
  {
    group: 'PRICING', defaultOpen: false, items: [
      {
        label: 'Curves', icon: 'trending-up', key: 'curves', href: 'curves.html', children: [
          ...
          { label: 'Settlement Curves', href: 'curves.html#settlement', key: 'settlement-curves' },
          { label: 'Spread Monitor', href: 'curves.html#spread-monitor', key: 'spread-monitor' },
        ]
      },
      { label: 'Index Builder', icon: 'activity', href: 'index-builder.html', key: 'index-builder' },
      { label: 'Curve Management', icon: 'settings', href: 'curve-management.html', key: 'curve-management' },
      { label: 'Market Data', icon: 'bar-chart-2', href: 'curve-management.html#sources', key: 'market-data' },
    ]
  },
  {
    group: 'SETTLEMENT', defaultOpen: false, items: [
      {
        label: 'Invoice Queue', icon: 'dollar', href: 'invoices.html', key: 'invoices', badge: { count: 3, color: 'red' }, children: [
          ...
          { label: 'Credit Notes', href: 'invoices.html#credit-notes', key: 'invoices-credit' },
        ]
      },
      { label: 'Reconciliation', icon: 'refresh-cw', href: 'reconciliation.html', key: 'reconciliation' },
      {
        label: 'Charges', icon: 'dollar', href: 'charges.html', key: 'charges', children: [
          { label: 'Cargo Charges', href: 'charges.html#cargo', key: 'charges-cargo' },
          { label: 'Charter & Fuel', href: 'charges.html#charter', key: 'charges-charter' },
          { label: 'Service & Agent', href: 'charges.html#service', key: 'charges-service' },
          { label: 'Finance & Tax', href: 'charges.html#finance', key: 'charges-finance' },
        ]
      },
      { label: 'Statements', icon: 'file-text', href: 'reconciliation.html', key: 'statements' },
    ]
  },
  {
    group: 'ADMIN', defaultOpen: false, items: [
      { label: 'Audit Log', icon: 'clock', href: 'audit-log.html', key: 'audit-log' },
      { label: 'Reminders', icon: 'alert-circle', href: 'reminders.html', key: 'reminders' },
      {
        label: 'Static Data', icon: 'clipboard', key: 'static-data', children: [
          { label: 'Counterparties', href: 'counterparties.html', key: 'ref-counterparties' },
          { label: 'Ports & Terminals', href: 'settings.html#ports', key: 'ref-ports' },
          { label: 'Vessels', href: 'settings.html#vessels', key: 'ref-vessels' },
          { label: 'Products', href: 'settings.html#products', key: 'ref-products' },
          { label: 'Manage Attributes', href: 'settings.html#attributes', key: 'ref-attributes' },
          { label: 'Payment Terms', href: 'settings.html#payment-terms', key: 'ref-payment-terms' },
          { label: 'Calendars', href: 'settings.html#calendars', key: 'ref-calendars' },
          { label: 'Charge Products', href: 'settings.html#charge-products', key: 'ref-charge-products' },
          { label: 'Lookups', href: 'settings.html#lookups', key: 'ref-lookups' },
        ]
      },
      {
        label: 'Security', icon: 'shield', key: 'security', children: [
      ...
      { label: 'Style Guide', icon: 'book', href: 'style-guide.html', key: 'style-guide' },
    ]
  },
  {
    group: 'SUPPORT', defaultOpen: false, items: [
      { label: 'System Status', icon: 'activity', href: 'support-dashboard.html', key: 'support-dashboard' },
      { label: 'Audit Search', icon: 'search', href: 'support-audit.html', key: 'support-audit' },
      {
        label: 'Data Quality', icon: 'shield', key: 'data-quality', href: 'support-data-quality.html', children: [
          { label: 'Curve Quality', href: 'support-data-quality.html#curves', key: 'dq-curves' },
          { label: 'Trade Integrity', href: 'support-data-quality.html#trades', key: 'dq-trades' },
          { label: 'Position Checks', href: 'support-data-quality.html#positions', key: 'dq-positions' },
        ]
      },
      { label: 'SQL Checks', icon: 'clipboard', href: 'support-sql-checks.html', key: 'support-sql-checks' },
      { label: 'Logs', icon: 'file-text', href: 'support-audit.html', key: 'logs' },
      { label: 'Help', icon: 'info', href: 'style-guide.html', key: 'help' },
    ]
  }
];
...
function buildSidebar(activePage) {
  ...
  html += '<div class="hz-sidebar-header">';
  ...
  html += '    <span>Horizon</span>';
  html += '    <span class="hz-sidebar-version">v14</span>';
  html += '  </div>';
  html += '</div>';
  ...
  MENU.forEach(function(group) {
    ...
    html += '  <button class="hz-menu-group-btn" onclick="toggleMenuGroup(\'' + gKey + '\')" tabindex="0" aria-expanded="' + gOpen + '">';
  ...
  html += '  <div class="hz-sidebar-user">';
  html += '    <div class="hz-avatar">JC</div>';
  html += '    <div class="hz-sidebar-user-info">';
  html += '      <div class="hz-sidebar-user-name">J. Cobley</div>';
  html += '      <div class="hz-sidebar-user-role">Trader &middot; Pacific LNG</div>';
  html += '    </div>';
  html += '    <a href="settings.html" class="hz-sidebar-settings-btn" title="Settings">' + svg('settings', 14) + '</a>';
  html += '  </div>';
  html += '</div>';

  // Sidebar Collapse Button
  html += '<button class="hz-sidebar-collapse-btn" id="hz-sidebar-toggle" onclick="toggleSidebar()" title="Toggle sidebar (Cmd+B)" tabindex="0" aria-label="' + (expanded ? 'Collapse sidebar' : 'Expand sidebar') + '">';
  html += svg(expanded ? 'chevrons-left' : 'chevrons-right', 16);
  html += '</button>';
...
function buildHeader(pageTitle) {
  ...
  html += '  <button class="hz-fullscreen-btn" onclick="toggleAppFullscreen()" title="Toggle fullscreen (F11)">' + svg('maximize', 14) + '</button>';
...
function buildStatusBar() {
  ...
  html += '<span style="margin-left:auto;">Horizon ETRM v14.0</span>';
  html += '</div>';
  return html;
}
...
function toggleAppFullscreen() {
  ...
  var btn = document.querySelector('.hz-header .hz-fullscreen-btn');
