/* ============================================================
   HORIZON ETRM v12.0 — AI-Aware Shared Shell Builder
...
/* ========== FULL ETRM MENU (v12 — AI-aware, EOS-complete) ========== */
var MENU = [
  {
...
function buildSidebar(activePage) {
  ...
  html += '    <span class="hz-sidebar-version">v12</span>';
  html += '  </div>';
  html += '</div>';
...
function buildStatusBar() {
  ...
  html += '<span style="margin-left:auto;">Horizon ETRM v12.0</span>';
  html += '</div>';
  return html;
}
