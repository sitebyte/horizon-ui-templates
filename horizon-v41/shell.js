...
function buildHeader(pageTitle) {
  ...
  html += '    <div class="hz-avatar" title="A. Morgan" tabindex="0" role="button" aria-label="User menu" onclick="toggleUserMenu(event)">AM</div>';
  ...
  html += '        <div class="hz-user-menu-avatar">AM</div>';
  html += '        <div class="hz-user-menu-identity">';
  html += '          <div class="hz-user-menu-name">Alex Morgan</div>';
  html += '          <div class="hz-user-menu-email">a.morgan@acmecorp.com</div>';
  html += '        </div>';
  html += '      </div>';
  html += '      <div class="hz-user-menu-meta">';
  html += '        <div class="hz-user-menu-meta-row">' + svg('briefcase', 12) + '<span>Senior Trader</span></div>';
  html += '        <div class="hz-user-menu-meta-row">' + svg('users', 12) + '<span>Commodities Desk</span></div>';
