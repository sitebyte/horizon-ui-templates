/* ============================================================
   HORIZON ETRM v10.0 — AI-Aware Shared Shell Builder
...
/* ========== FULL ETRM MENU (v10 — AI-aware, EOS-aligned) ========== */
var MENU = [
  {
...
function buildHeader(pageTitle) {
  ...
  html += '  <button class="hz-header-toggle" id="hz-sidebar-toggle" onclick="toggleSidebar()" title="Toggle sidebar (Cmd+B)" tabindex="0" aria-label="Toggle sidebar">' + svg(sidebarExp ? 'chevron-left' : 'chevron-right', 16) + '</button>';
...
function buildStatusBar() {
  ...
  html += '<span style="margin-left:auto;">Horizon ETRM v10.0</span>';
  html += '</div>';
  return html;
}
