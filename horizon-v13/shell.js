/* ============================================================
   HORIZON ETRM v13.0 — AI-Aware Shared Shell Builder
...
/* ========== FULL ETRM MENU (v13 — AI-aware, EOS-complete) ========== */
var MENU = [
  {
...
function buildSidebar(activePage) {
  ...
  html += '    <span class="hz-sidebar-version">v13</span>';
  html += '  </div>';
  html += '</div>';
...
function buildStatusBar() {
  ...
  html += '<span style="margin-left:auto;">Horizon ETRM v13.0</span>';
  html += '</div>';
  return html;
}
...
function initShell(activePage, pageTitle) {
  ...
  // Add fullscreen buttons to all cards with headers
  setTimeout(function() {
    document.querySelectorAll('.hz-card-header, .td-section').forEach(function(header) {
      if (header.querySelector('.hz-fullscreen-btn')) return; // already has one
      var btn = document.createElement('button');
      btn.className = 'hz-fullscreen-btn';
      btn.title = 'Toggle fullscreen';
      btn.innerHTML = svg('maximize', 12);
