/* ============================================================
   HORIZON ETRM v18.0 — AI-Aware Shared Shell Builder
...
/* ========== EOS MENU (v18 — exact EOS structure, flat top-level) ========== */
var MENU = [
  /* EOS flat menu structure — 16 top-level items matching production EOS exactly */
  ...
  { group: 'COUNTERPARTIES', defaultOpen: false, items: [
  ...
  { group: 'SHIPMENTS', defaultOpen: false, items: [
    ...
    { label: 'Nominations', icon: 'file-text', href: 'nominations.html', key: 'nominations', badge: { count: 2, color: 'amber' } },
  ]},
  { group: 'VALUATIONS', defaultOpen: false, items: [
    { label: 'Valuations', icon: 'trending-up', href: 'valuations.html', key: 'valuations' },
    { label: 'Portfolio', icon: 'bar-chart-2', href: 'valuations.html#portfolio', key: 'portfolio' },
  ]},
  ...
  { group: 'PRICES', defaultOpen: false, items: [
    { label: 'Curves', icon: 'trending-up', href: 'curves.html', key: 'curves' },
  ...
  { group: 'STATIC DATA', defaultOpen: false, items: [
    ...
    { label: 'Tax', icon: 'dollar', href: 'settings.html#tax', key: 'ref-tax' },
    {
    ...
    { label: 'Reports', icon: 'file-text', href: 'settings.html#reports', key: 'ref-reports' },
    {
...
function buildStatusBar() {
  ...
  html += '<span style="margin-left:auto;">Horizon ETRM v18.0</span>';
  html += '</div>';
  return html;
}
